...
export default function (data) {
  ...
  data.footer = `This comment was generated by [Terraform Pull Request Report Generator](https://github.com/guledm12/action-terraform-report) - action run [\`#${runId}\`](https://github.com/${repo.owner}/${repo.repo}/actions/runs/${runId}) - commit ${sha}`
